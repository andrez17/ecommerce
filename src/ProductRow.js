...
export const ProductRow = (props) => {
    ...
    return (
        <div className="productRowContainer">
            ...
            <NavLink to="/products/jackets" onClick={() => {
                // dispatch(setCategory("jackets"))
                }}>
                <img key={1} src="https://fakestoreapi.com/img/81XH0e8fefL._AC_UY879_.jpg" alt="img"/>
                <h2>Jackets</h2>
            </NavLink>
            <NavLink to="/products/electronics" onClick={() => {
                // dispatch(setCategory("misc"))
                }}>
